            ...
            <div class="bg-white rounded p-4">
                ...
                <form action="{{route('login.action')}}" method="POST" autocomplete="off">
                    ...
                    <div class="flex flex-col my-3">
                        ...
                        <input type="text" name="email" placeholder="Enter email here" class="shadow-sm flex-1 rounded-lg border-2 p-2 outline-none focus:border-green-500">
                    </div>
                    <div class="flex flex-col my-3">
                        <label for="" class="font-xs text-gray-500">Password</label>
                        <input type="password" name="password" placeholder="Enter Password here" class="shadow-sm  rounded-lg flex-1 border-2 p-2 outline-none focus:border-green-500">
                    </div>
                    <div class="flex">
